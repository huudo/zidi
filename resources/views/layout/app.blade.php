...
<!-- CSS | Theme Color -->
<link href="{{asset('public/css/colors/theme-skin-color-set-1.css')}}" rel="stylesheet" type="text/css">
      ...
      <div class="container pt-0 pb-0">
        <div class="row">
          <div class="col-xs-12 col-sm-4 col-md-5">
            <div class="widget no-border m-0">
              <a class="menuzord-brand pull-left flip xs-pull-center mb-15" href="javascript:void(0)"><img src="{{asset('public/images/logo-wide.png')}}" alt=""></a>
            </div>
          </div>
      ...
      <div class="row border-bottom">
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            <img class="mt-5 mb-20" alt="" src="{{asset('public/images/logo-white-footer.png')}}">
